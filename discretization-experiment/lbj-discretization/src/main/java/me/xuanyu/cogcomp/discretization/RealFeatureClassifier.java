...
public class RealFeatureClassifier extends SparseAveragedPerceptron
{
  private static void loadInstance()
  {
    if (instance == null) instance = new RealFeatureClassifier(true);
  }

  public static Parser getParser() { return new FeatureReader("../data/data.train"); }
  public static Parser getTestParser() { return new FeatureReader("../data/data.test"); }

  public static boolean isTraining;
  public static RealFeatureClassifier instance;

  public static RealFeatureClassifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private RealFeatureClassifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "me.xuanyu.cogcomp.discretization";
    name = "RealFeatureClassifier";
    setEncoding(null);
    setLabeler(new InstanceLabel());
    setExtractor(new FeatureSet());
    isClone = false;
  }
  ...
  public RealFeatureClassifier()
  {
    super("me.xuanyu.cogcomp.discretization.RealFeatureClassifier");
    isClone = true;
  }

  public RealFeatureClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public RealFeatureClassifier(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(RealFeatureClassifier.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(RealFeatureClassifier.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(RealFeatureClassifier.class, lexiconPath));
    }
    else {
      containingPackage = "me.xuanyu.cogcomp.discretization";
      name = "RealFeatureClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof String || example instanceof Object[]))
      {
        String type = example == null ? "null" : example.getClass().getName();
        System.err.println("Classifier 'RealFeatureClassifier(String)' defined on line 24 of RealFeatures.lbj received '" + type + "' as input.");
  ...
  public void learn(Object[] examples)
  {
    if (isClone)
    {
      if (!(examples instanceof String[] || examples instanceof Object[][]))
      {
  ...
  public Feature featureValue(Object __example)
  {
    if (isClone)
    {
      if (!(__example instanceof String || __example instanceof Object[]))
      {
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: me.xuanyu.cogcomp.discretization.RealFeatureClassifier \\");
    ...
    RealFeatureClassifier classifier = new RealFeatureClassifier();
  ...
  public int hashCode() { return "RealFeatureClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof RealFeatureClassifier; }
  ...
  public java.lang.String[] getAllowableValues()
  {
    ...
    {
      loadInstance();
      return instance.getAllowableValues();
    }

    return super.getAllowableValues();
  }
  ...
  public double getBias()
  {
    ...
    {
      loadInstance();
      return instance.getBias();
    }

    return super.getBias();
  }

  public edu.illinois.cs.cogcomp.lbjava.learn.SparseWeightVector getWeightVector()
  {
    if (isClone)
    {
      loadInstance();
